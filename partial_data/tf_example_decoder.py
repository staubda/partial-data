"""TF Object Detection example decoders updated to handle per example class masks.
"""
...
from object_detection.data_decoders.tf_example_decoder import _ClassTensorHandler, _BackupHandler

from partial_data import standard_fields as fields
...
class TfExampleDecoder(data_decoder.DataDecoder):
    ...
    def __init__(self,
        ...
        self.keys_to_features = {
            ...
            # DS-TODO: add in class mask here
            'image/class_mask': tf.VarLenFeature(tf.int64),
        ...
        self.items_to_handlers = {
            ...
            # DS-TODO: add in class mask here
            fields.InputDataFields.class_mask: (slim_example_decoder.Tensor('image/class_mask')),
        ...
        if num_additional_channels > 0:
            self.keys_to_features['image/additional_channels/encoded'] = tf.FixedLenFeature((num_additional_channels,),
                                                                                            tf.string)
        ...
        if num_keypoints > 0:
            ...
            self.items_to_handlers[fields.InputDataFields.groundtruth_keypoints] = (
                slim_example_decoder.ItemHandlerCallback(['image/object/keypoint/y', 'image/object/keypoint/x'],
        ...
        if load_instance_masks:
            if instance_mask_type in (input_reader_pb2.DEFAULT, input_reader_pb2.NUMERICAL_MASKS):
                ...
                self.items_to_handlers[fields.InputDataFields.groundtruth_instance_masks] = (
                    slim_example_decoder.ItemHandlerCallback(['image/object/mask', 'image/height', 'image/width'],
        ...
        if label_map_proto_file:
            ...
            label_handler = _BackupHandler(
                _ClassTensorHandler('image/object/class/text', label_map_proto_file, default_value=''),
                slim_example_decoder.Tensor('image/object/class/label'))
            image_label_handler = _BackupHandler(
                _ClassTensorHandler(fields.TfExampleFields.image_class_text, label_map_proto_file, default_value=''),
    ...
    def decode(self, tf_example_string_tensor):
        ...
        tensor_dict[fields.InputDataFields.groundtruth_weights] = tf.cond(
            tf.greater(tf.shape(tensor_dict[fields.InputDataFields.groundtruth_weights])[0], 0),
            lambda: tensor_dict[fields.InputDataFields.groundtruth_weights], default_groundtruth_weights)
